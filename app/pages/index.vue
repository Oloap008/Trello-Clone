...
<template>
  <div class="flex items-center justify-center flex-col">
    <div :class="['flex items-center justify-center flex-col', 'heading-font']">
      <div
      ...
      >
        <UIcon name="i-lucide-medal" class="h-6 w-6 mr-2" />
        No 1 task managment
      </div>
      <h1
        class="text-3xl md:text-6xl text-center text-neutral-800 mb-6"
    ...
    <UButton class="mt-6" size="lg" :to="'/sign-up'" data-testid="main_button">
